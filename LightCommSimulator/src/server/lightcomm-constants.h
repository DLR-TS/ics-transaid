...
***************************************************************************************/
#ifndef LIGHTCOMM_CONSTANTS_H
#define LIGHTCOMM_CONSTANTS_H
...
// command: get all the messages from all the active nodes
#define CMD_GET_ALL_RECEIVED_MESSAGES 0x17
