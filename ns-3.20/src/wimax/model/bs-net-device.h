...
// Added by Ramon first, then by Andrea
...
public:
  enum State
  {
	  // Modified Ramon first, then by Andrea
...
private:
  ...
  void EndFrame (void);
  // Added Ramon first, then by Andrea
  void StartFrameItetris (void);
  void StartDlSubFrameItetris (void);
  void EndDlSubFrameItetris (void);
  void StartUlSubFrameItetris (void);
  void EndUlSubFrameItetris (void);
  void EndFrameItetris (void);
