...
public:
  ...
  virtual void SetPromisc (void); // aggiunto per evitare errori di compilazione
  virtual void SetRifs (Time rifs); // aggiunto per evitare errori di compilazione
  ...
  virtual Time GetRifs (void) const; // aggiunto per evitare errori di compilazione
