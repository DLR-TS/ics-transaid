...
#ifndef DSRC_ERROR_RATE_MODEL_H
#define DSRC_ERROR_RATE_MODEL_H
 ...
 */
class DSRCErrorRateModel : public ErrorRateModel
{
public:
...
private:
   ...
   * \param snr
   * 
   * \return FER (Frame Error Ratio as a function of EbNo when L = 1)
   */
  double GetBERQpsk_IEEE80211p(double snr) const;
  /**
