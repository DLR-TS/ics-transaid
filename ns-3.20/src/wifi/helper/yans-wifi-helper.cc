...
Ptr<YansWifiChannel>  //// cerated for iTETRIS
...
static ns3::GlobalValue g_errorModel ("WifiPhyHelperErrorModel",
																			"The default error model. Should be either 'ns3::NistErrorRateModel' of 'ns3::YansErrorRateModel'",
																			ns3::StringValue("ns3::YansErrorRateModel"),
...
YansWifiPhyHelper::Default (void)
{
  ...
  StringValue value;
  g_errorModel.GetValue(value);
  NS_LOG_UNCOND("YansWifiPhyHelper::Default "<<value.Get());
  if(value.Get() == "ns3::NistErrorRateModel" || value.Get() == "ns3::YansErrorRateModel")
  	helper.SetErrorRateModel (value.Get());
  else
