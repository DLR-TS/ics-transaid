...
//jin comment this
  ...
  if (m_c2cEnabled)
  {
   ...
   {
	 //std::cout<<"InternetStackHelper::Install:"<< node->GetDevice(i)->GetTypeId()<<std::endl;
	 if(DynamicCast<WifiNetDevice>(node->GetDevice(i)))
	   {
		 //std::cout<<"InternetStackHelper::Install Wifi found!!!"<<std::endl;
