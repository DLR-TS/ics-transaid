...
{
public:
	typedef std::vector<Ipv6Address> Ipv6AddrList;
  ...
  */
  ...
  void AddIpv6AddressSender(Ipv6Address addr);
  Ipv6Address GetIpv6AddressSender(uint32_t i);
  uint32_t GetIpv6ListSize() const;
