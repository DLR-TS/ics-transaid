...
public:
  ...
  /* restituisce i byte corrispondenti al prefisso dell'indirizzo*/
  void getPrefixBytes(uint8_t *pref, uint32_t prefixLength);
   ...
   * \return bytes of the address
  */
  uint8_t* GetBytes2 (uint8_t buf[16]) const;
