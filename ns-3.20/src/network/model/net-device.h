...
*/
  ...
  virtual void ActivateNetDevice (void) const {}; // Added by Ramon Bauza, then by Andrea

  virtual void DeactivateNetDevice (void) const {}; // Added by Ramon Bauza, then by Andrea
